...
when ODIN_OS == .Linux {
	foreign import sqlite3 {"system:sqlite3", "system:pthread", "system:dl", "system:m"}
...
VFS :: struct {
	...
	delete:           proc "c" (vfs: ^VFS, name: cstring, sync: b32) -> Status,
	access:           proc "c" (vfs: ^VFS, name: cstring, flags: Access_Flags, res_out: ^i32) -> Status,
	full_pathname:    proc "c" (vfs: ^VFS, name: cstring, buf_size: i32, buf: [^]u8) -> Status,
	dl_open:          proc "c" (vfs: ^VFS, name: cstring) -> rawptr,
	dl_error:         proc "c" (vfs: ^VFS, buf_size: i32, buf: [^]u8),
	dl_sym:           proc "c" (vfs: ^VFS, dl: rawptr, sym: cstring) -> rawptr,
	randomness:       proc "c" (vfs: ^VFS, buf_size: i32, buf: [^]u8) -> Status,
	sleep:            proc "c" (vfs: ^VFS, microseconds: i32) -> Status,
	current_time:     proc "c" (vfs: ^VFS, out: ^f64) -> Status,
	last_error:       proc "c" (vfs: ^VFS, wtf: i32, wtf2: cstring) -> Status,
...
foreign sqlite3 {
	...
	exec :: proc(conn: ^Sqlite3, sql: cstring, callback: proc "c" (ctx: rawptr, n_columns: i32, col_values: [^]cstring, col_names: [^]cstring), ctx: rawptr, errmsg: ^cstring) -> Status ---
}
...
foreign sqlite3 {
	...
	busy_handler :: proc(conn: ^Sqlite3, handler: proc "c" (ctx: rawptr, n_times_invoked: i32) -> Status, ctx: rawptr) -> Status ---
	// Set a busy timeout.
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	set_authorizer :: proc(conn: ^Sqlite3, auth: proc "c" (ctx: rawptr, action: Auth_Action, arg1: cstring, arg2: cstring, arg3: cstring, arg4: cstring) -> Status, ctx: rawptr) -> Auth_Code ---
}
...
foreign sqlite3 {
	...
	trace_v2 :: proc(conn: ^Sqlite3, mask: Trace_Mask, callback: proc "c" (level: Trace_Level, ctx: rawptr, arg1: rawptr, arg2: rawptr), ctx: rawptr) -> Status ---
}

@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	// Query progress callback.
	progress_handler :: proc(conn: ^Sqlite3, n: i32, callback: proc "c" (ctx: rawptr) -> (interrupt: b32), ctx: rawptr) ---
}
...
foreign sqlite3 {
	...
	create_filename :: proc(db: cstring, journal: cstring, wal: cstring, n_param: i32, params: [^]cstring) -> cstring ---
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	prepare_v2 :: proc(conn: ^Sqlite3, sql: [^]u8, sql_len: i32, out_stmt: ^^Stmt, out_unused: ^[^]u8) -> Status ---
	prepare_v3 :: proc(conn: ^Sqlite3, sql: cstring, sql_size: i32, flags: Prepare_Flags, out_stmt: ^^Stmt, out_unused: ^cstring) -> Status ---

	prepare16_v2 :: proc(conn: ^Sqlite3, sql: [^]u16, sql_size: i32, out_stmt: ^^Stmt, out_unused: ^[^]u16) -> Status ---
	prepare16_v3 :: proc(conn: ^Sqlite3, sql: [^]u16, sql_size: i32, flags: Prepare_Flags, out_stmt: ^^Stmt, out_unused: ^[^]u16) -> Status ---
	...
	bind_blob :: proc(stmt: ^Stmt, n: i32, data: rawptr, size: i32, destructor: Destructor) -> Status ---
	bind_blob64 :: proc(stmt: ^Stmt, n: i32, data: rawptr, size: i64, destructor: Destructor) -> Status ---
	bind_text :: proc(stmt: ^Stmt, n: i32, data: [^]u8, size: i32, destructor: Destructor) -> Status ---
	bind_text16 :: proc(stmt: ^Stmt, n: i32, data: [^]u16, size: i32, destructor: Destructor) -> Status ---
	bind_text64 :: proc(stmt: ^Stmt, n: i32, data: cstring, size: i64, destructor: Destructor, encoding: Encoding) -> Status ---
	bind_double :: proc(stmt: ^Stmt, n: i32, value: f64) -> Status ---
	bind_int :: proc(stmt: ^Stmt, n: i32, value: i32) -> Status ---
	bind_int64 :: proc(stmt: ^Stmt, n: i32, value: i64) -> Status ---
	bind_null :: proc(stmt: ^Stmt, n: i32) -> Status ---
	bind_value :: proc(stmt: ^Stmt, n: i32, value: ^Value) -> Status ---
	bind_zeroblob :: proc(stmt: ^Stmt, n: i32, size: i32) -> Status ---
	bind_zeroblob64 :: proc(stmt: ^Stmt, n: i32, size: i64) -> Status ---
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	create_function :: proc(conn: ^Sqlite3, name: cstring, n_args: i32, text_rep: Function_Flags, ctx: rawptr, func: proc "c" (ctx: ^Context, a: i32, b: ^^Value), step: proc "c" (ctx: ^Context, a: i32, b: ^^Value), final: proc "c" (ctx: ^Context)) -> Status ---
	create_function16 :: proc(conn: ^Sqlite3, name: [^]u16, n_args: i32, text_rep: Function_Flags, ctx: rawptr, func: proc "c" (ctx: ^Context, a: i32, b: ^^Value), step: proc "c" (ctx: ^Context, a: i32, b: ^^Value), final: proc "c" (ctx: ^Context)) -> Status ---
	create_function_v2 :: proc(conn: ^Sqlite3, name: cstring, n_args: i32, text_rep: Function_Flags, ctx: rawptr, func: proc "c" (ctx: ^Context, a: i32, b: ^^Value), step: proc "c" (ctx: ^Context, a: i32, b: ^^Value), final: proc "c" (ctx: ^Context), destroy: proc "c" (ptr: rawptr)) -> Status ---
	create_window_function :: proc(conn: ^Sqlite3, name: cstring, n_args: i32, text_rep: Function_Flags, ctx: rawptr, step: proc "c" (ctx: ^Context, a: i32, b: ^^Value), final: proc "c" (ctx: ^Context), value: proc "c" (ctx: ^Context), inverse: proc "c" (ctx: ^Context, a: i32, b: ^^Value), destroy: proc "c" (ptr: rawptr)) -> Status ---
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	create_collation :: proc(conn: ^Sqlite3, name: cstring, encoding: Encoding, ctx: rawptr, compare: proc "c" (ctx: rawptr, e1: Encoding, s1: rawptr, e2: Encoding, s2: rawptr) -> b32) -> Status ---
	create_collation16 :: proc(conn: ^Sqlite3, name: [^]u16, encoding: Encoding, ctx: rawptr, compare: proc "c" (ctx: rawptr, e1: Encoding, s1: rawptr, e2: Encoding, s2: rawptr) -> b32) -> Status ---
	create_collation_v2 :: proc(conn: ^Sqlite3, name: cstring, encoding: Encoding, ctx: rawptr, compare: proc "c" (ctx: rawptr, e1: Encoding, s1: rawptr, e2: Encoding, s2: rawptr) -> b32, destroy: Destructor) -> Status ---
	collaction_needed :: proc(conn: ^Sqlite3, ctx: rawptr, callbacj: proc "c" (ctx: rawptr, conn: ^Sqlite3, enc: Encoding)) -> Status ---
	collaction_needed16 :: proc(conn: ^Sqlite3, ctx: rawptr, callbacj: proc "c" (ctx: rawptr, conn: ^Sqlite3, enc: Encoding)) -> Status ---
}
...
foreign sqlite3 {
	...
	commit_hook :: proc(conn: ^Sqlite3, hook: proc "c" (ctx: rawptr) -> i32, ctx: rawptr) -> rawptr ---
	rollback_hook :: proc(conn: ^Sqlite3, hook: proc "c" (ctx: rawptr) -> i32, ctx: rawptr) -> rawptr ---
	autovacuum_pages :: proc(conn: ^Sqlite3, callback: proc "c" (ctx: rawptr, schema: cstring, n_db_page: u32, n_free_page: u32, n_page_size: u32), ctx: rawptr, destructor: Destructor) -> Status ---
	update_hook :: proc(conn: ^Sqlite3, hook: proc "c" (ctx: rawptr, stmt_kind: i32, db_name: cstring, table_name: cstring, rowid: i64), ctx: rawptr) -> rawptr ---
	...
	table_column_metadata :: proc(conn: ^Sqlite3, db_name: cstring, table_name: cstring, column_name: cstring, out_data_type: ^cstring, out_coll_seq: ^cstring, out_not_null: ^b32, out_primary_key: ^b32, out_auto_inc: ^b32) -> Status ---
	load_extension :: proc(conn: ^Sqlite3, so_file: cstring, entry_point: cstring, out_err_msg: ^cstring) -> Status ---
...
Module :: struct {
	...
	best_index:    proc "c" (vtab: ^VTab, out_index_info: ^Index_Info) -> Status,
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	create_module :: proc(conn: ^Sqlite3, mod_name: cstring, methods: ^Module, ctx: rawptr) -> Status ---
	create_module_v2 :: proc(conn: ^Sqlite3, mod_name: cstring, methods: ^Module, ctx: rawptr, destructor: Destructor) -> Status ---
	drop_modules :: proc(conn: ^Sqlite3, keep: [^]cstring) -> Status ---
}
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	declare_vtab :: proc(conn: ^Sqlite3, sql: cstring) -> Status ---
	ooverload_function :: proc(conn: ^Sqlite3, func_name: cstring, arg: i32) -> Status ---
}
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	blob_open :: proc(conn: ^Sqlite3, db: cstring, table: cstring, column: cstring, rowid: i64, flags: b32, out_blob: ^Blob) -> Status ---
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	file_control :: proc(conn: ^Sqlite3, db_name: cstring, op: Fcntl_Opcode, arg: rawptr) -> Status ---
}
...
@(link_prefix = "sqlite3_", default_calling_convention = "c")
foreign sqlite3 {
	status :: proc(op: Status_Op, cur: ^i32, high_water: ^i32, reset: b32) -> Status ---
	status64 :: proc(op: Status_Op, cur: ^i64, high: ^i64, reset: b32) -> Status ---
	db_status :: proc(conn: ^Sqlite3, op: DB_Status_Op, cur: ^i32, high: ^i32, reset: b32) -> Status ---
	stmt_status :: proc(conn: ^Sqlite3, op: Stmt_Status_Op, reset: b32) -> Status ---
}
